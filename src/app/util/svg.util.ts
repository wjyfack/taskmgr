...
export const loadSvgResources = (ir: MdIconRegistry, ds: DomSanitizer) => {
    ...
    const avaterDir = `${imgDir}/avatar`;
    const iconDir = `${imgDir}/icons`;
    ir.addSvgIconSetInNamespace('avatars', ds.bypassSecurityTrustResourceUrl(`${avaterDir}/avatars.svg`));
    ...
    ir.addSvgIcon('unassigned', ds.bypassSecurityTrustResourceUrl(`${avaterDir}/unassigned.svg`));
